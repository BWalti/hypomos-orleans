                       ...
                       <div className="row" id="hero">
                           <div className="container">
                               <div id="tagline">
                                   <ScrollEffect animate="bounceIn">
                                       ...
                                       <h3 className="home-intro-text">
                                           Introducing the
                                           <Scroll
                                               .Link to="demo" href="#" smooth={true} duration={700} offset={0}>
                                               RROD
                                           </Scroll
                                           .Link> stack
                                       </h3>
                               ...
                               <div className="down-link">
                                   <Scroll.Link to="demo" href="#" className="icon-link" smooth={true} duration={700} offset={
0}>
                                       <i className="fa fa-arrow-circle-down custom"></i>
                                   </Scroll.Link>
                               </div>
                           </div>
                       </div>
                   ...
                   <Fullscreen>
                       <div className="row" id="demo">
                           <div className="container">
                               <h1>Page 2</h1>
                               <div className="down-link">
                                   <Scroll.Link to="footer" href="#" className="icon-link" smooth={true} duration={700
} offset={0}>
                                       <i className="fa fa-arrow-circle-down custom"></i>
                                   </Scroll.Link>
                               </div>
