                   ...
                   <div className="container">
                       ...
                       <div className="row">
                           { this.props.submitted
                               ...
                               : <Form inline method="post" action="/subscribe" onSubmit={this.submitEmail}>
                                     <input type="hidden" name="requestVerificationToken" defaultValue={this.props
                                         .xsrfToken}/>
                       ...
                       <div className="row" id="share">
                           <ul className="socials-links">
                               <li>
                                   <a href="https://www.facebook.com/YourFbPage">
                               ...
                               <li>
                                   <a href="https://nl.linkedin.com/in/YourLinkedInProfile">
