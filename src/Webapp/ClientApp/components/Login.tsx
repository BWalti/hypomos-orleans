...
import { Grid, Col, Row, Button, Checkbox, Form, FormGroup, FormControl, InputGroup, HelpBlock } from "react-bootstrap";
                           ...
                           <Form className="omb_loginForm" onSubmit={(e) => this.login(e)} autoComplete="off">
                               <FormGroup validationState={this.getValidationState()}>
                                   <InputGroup>
                                       ...
                                       <FormControl name="email" type="text" onChange={(e) => this.handleChange(e)
} placeholder="Email"/>
                                   </InputGroup>
                               ...
                               <FormGroup validationState={this.props.loginError ? "error" : null}>
                                   <InputGroup>
                                       ...
                                       <FormControl name="password" type="password" onChange={(e) => this.handleChange(e)
