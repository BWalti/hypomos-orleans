...
import { Grid, Row, Col, Well, Button, FormGroup, Form, FormControl } from "react-bootstrap";
                                   ...
                                   <fieldset>
                                       ...
                                       <FormGroup>
                                           <Col md={10} mdOffset={1}>
                                               <FormControl name="email" type="text" onChange={this.handleChange} value={
this.state.email} placeholder="email@domain.com"/>
                                           </Col>
                                       </FormGroup>
                                       <FormGroup>
                                           <Col md={10} mdOffset={1}>
                                       ...
                                       <FormGroup>
                                           <Col md={11} className="text-center">
                                            ...
                                            .isSubmitting}>{
                                                this.props.isSubmitting ? "Spinner" : "Register" }</Button>
                                           </Col>
                                       </FormGroup>
                                   </fieldset>
                               </Form>
