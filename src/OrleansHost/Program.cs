                ...
                silo = new SiloHostBuilder().UseEnvironment(environment).ConfigureLogging((context, logging) =>
                    ...
                    }).ConfigureAppConfiguration((context, builder) =>
                    {
                        builder.SetBasePath(Directory.GetCurrentDirectory())
                            ...
                            .AddEnvironmentVariables(
                                "RROD_"); // can override all settings (i.e. URLS) by passing an environment variable
                    ...
                    .ConfigureServices((context, services) =>
                    {
                        ...
                        services.UseAdoNetReminderService(options =>
                            options.Configure(ropts => ropts.ConnectionString = dataConnectionString));
                    ...
                    .AddAdoNetGrainStorageAsDefault(builder =>
                        builder.Configure((AdoNetGrainStorageOptions opts, IConfiguration cfg) =>
                            opts.ConnectionString = cfg.GetConnectionString("DataConnectionString")))
                    .AddAdoNetGrainStorage("PubSubStore",
                        builder => builder.Configure((AdoNetGrainStorageOptions opts, IConfiguration cfg) =>
                            opts.ConnectionString = cfg.GetConnectionString("DataConnectionString")))
